...
keypoints, query_descriptors = brisk.detectAndCompute(query_image, None)
...
for i in range(len(imgnames)):
    keypoints, descriptors = brisk.detectAndCompute(cv2.imread("oxbuild_images/"+imgnames[i], 0), None)

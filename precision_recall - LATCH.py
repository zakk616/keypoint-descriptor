...
keypoints, query_descriptors = latch.detectAndCompute(query_image, mask=None)
...
for i in range(len(imgnames)):
    keypoints, descriptors = latch.detectAndCompute(cv2.imread("oxbuild_images/"+imgnames[i], 0), None)
...
plt.suptitle("Image Simillarity", size=16)

...
keypoints, query_descriptors = surf.detectAndCompute(query_image, None)
...
for i in range(len(imgnames)):
    keypoints, descriptors = surf.detectAndCompute(cv2.GaussianBlur(cv2.imread("oxbuild_images/"+imgnames[i], 0), (5, 5), 0), None)
